...
# v0.4 orbital extreme report wrappers

# v0.5 orbital wrappers
def RocketMaterialConfig(*args, **kwargs): return _lazy("orbital", "RocketMaterialConfig")(*args, **kwargs)
def RocketShapeConfig(*args, **kwargs): return _lazy("orbital", "RocketShapeConfig")(*args, **kwargs)
def WindTunnelConfig(*args, **kwargs): return _lazy("orbital", "WindTunnelConfig")(*args, **kwargs)
def TurbineDesignConfig(*args, **kwargs): return _lazy("orbital", "TurbineDesignConfig")(*args, **kwargs)
def OptimizationConfig(*args, **kwargs): return _lazy("orbital", "OptimizationConfig")(*args, **kwargs)
def VideoRenderConfig(*args, **kwargs): return _lazy("orbital", "VideoRenderConfig")(*args, **kwargs)
def simulate_wind_tunnel(*args, **kwargs): return _lazy("orbital", "simulate_wind_tunnel")(*args, **kwargs)
def optimize_rocket_shape(*args, **kwargs): return _lazy("orbital", "optimize_rocket_shape")(*args, **kwargs)
def optimize_turbine_geometry(*args, **kwargs): return _lazy("orbital", "optimize_turbine_geometry")(*args, **kwargs)
def generate_orbital_mission_videos(*args, **kwargs): return _lazy("orbital", "generate_orbital_mission_videos")(*args, **kwargs)

def ProfessionalDossierConfig(*args, **kwargs): return _lazy("orbital", "ProfessionalDossierConfig")(*args, **kwargs)
def ProfessionalDossierResult(*args, **kwargs): return _lazy("orbital", "ProfessionalDossierResult")(*args, **kwargs)
def build_professional_orbital_dossier(*args, **kwargs): return _lazy("orbital", "build_professional_orbital_dossier")(*args, **kwargs)
def OrbitalVehicleConfig(*args, **kwargs): return _lazy("orbital", "OrbitalVehicleConfig")(*args, **kwargs)
def OrbitalMissionConfig(*args, **kwargs): return _lazy("orbital", "OrbitalMissionConfig")(*args, **kwargs)
def OrbitalMissionLatexReport(*args, **kwargs): return _lazy("orbital", "OrbitalMissionLatexReport")(*args, **kwargs)
def build_orbital_mission_report(*args, **kwargs): return _lazy("orbital", "build_orbital_mission_report")(*args, **kwargs)
def simulate_orbital_reentry_and_capture(*args, **kwargs): return _lazy("orbital", "simulate_orbital_reentry_and_capture")(*args, **kwargs)
def generate_orbital_mission_figures(*args, **kwargs): return _lazy("orbital", "generate_orbital_mission_figures")(*args, **kwargs)
...
__all__ = [
    ...
    "RocketMaterialConfig", "RocketShapeConfig", "WindTunnelConfig", "TurbineDesignConfig", "OptimizationConfig", "VideoRenderConfig",
    "OrbitalVehicleConfig", "OrbitalMissionConfig", "OrbitalMissionLatexReport", "build_orbital_mission_report", "simulate_orbital_reentry_and_capture", "generate_orbital_mission_figures", "generate_orbital_mission_videos", "simulate_wind_tunnel", "optimize_rocket_shape", "optimize_turbine_geometry", "ProfessionalDossierConfig", "ProfessionalDossierResult", "build_professional_orbital_dossier",
]
